...
public class BookDaoImpl implements BookDao {
    ...
    public void deleteCopy(long id) {
        ...
        Query query = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call DeleteOneBookCopy(:bookName)");
    ...
    public Book save(Book book) {
        ...
        Query query = sessionFactory
                .getCurrentSession()
                .createQuery("select a from Author a where a.firstName=:name and a.lastName=:surname");
    ...
    public Book delete(long id) {
        ...
        Query query = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call DeleteBookWithAllCopies(:bookName)");
        query.setParameter("bookName", bookName);
        query.executeUpdate();
        return book;
    }
    ...
    public List<Book> getOwnBooks(String action, Long userID) {
        ...
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call getOwnBooks(:id,:action)")
    ...
    public List<Book> FindBookByName(String name) {
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call FindBookByTitle(:Book_Name)")
                .addEntity(Book.class);
    ...
    public List<Book> FindBookByAuthor(String name) {
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call Find(:Book_Name)")
                .addEntity(Book.class);
        query1.setParameter("Book_Name", name);
        return query1.getResultList();
    }
    ...
    public List<Book> FindMostPopular(LocalDate start, LocalDate end) {
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call FindMostPopular(:start,:end)")
                .addEntity(Book.class);
    ...
    public List<Book> FindLeastPopular(LocalDate start, LocalDate end) {
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call FindLeastPopular(:start,:end)")
                .addEntity(Book.class);
        query1.setParameter("start", start);
        query1.setParameter("end", end);
        return query1.getResultList();
    ...
    public List<Book> FindAvailable() {
        return sessionFactory
                .getCurrentSession()
                .createQuery("select b from Book b where b.count > 0", Book.class)
                .getResultList();
    }
    ...
    public List<Integer> FindTime(Long userID) {
        ...
        Query query1 = sessionFactory
                .getCurrentSession()
                .createSQLQuery("call UserStat(:id)");
        query1.setParameter("id", userID);
        bookList = query1.getResultList();
    ...
    public List<String> getAuthors() {
        return (List<String>) sessionFactory
                .getCurrentSession()
                .createSQLQuery("call GetStatByBook()")
                .getResultList();
    }
    ...
    public List<Double> getDuration() {
        return (List<Double>) sessionFactory
                .getCurrentSession()
                .createSQLQuery("call duration1()")
                .getResultList();
    }
